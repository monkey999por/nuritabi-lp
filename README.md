...
「ピンをつないで、旅行記録を完成させる。」をコンセプトにした、ロングドライブ向け旅程記録サービス『塗り旅』のウェイティングリスト用ランディングページです。
...
- 全デザイン共通: **実データの旅程マップ再生**・スポット数/km 表示・Google Form 埋め込み・デザインシャッフル
...
src/trip-map.svg       ← 実データ旅程 SVG（2026年4月 東北・5日間・26スポット・道なりルート）
...
- [ ] スマホ実機で: ランダム振り分け → 旅程マップ再生 → 🎲シャッフル / フォーム送信 / 横スクロールが無いこと
